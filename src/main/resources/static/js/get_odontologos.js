      ...
      fetch(url,settings)
        ...
        .then(function (info) {
            ...
            for(let i=0;i<info.length;i++){
                ...
                odontologoRow.innerHTML = '<td class="td_id">' + info[i].id + '</td>' + '<td class="td_nombre">' + info[i].nombre.toUpperCase() + '</td>' +
                    '<td class="td_apellido">' + info[i].apellido.toUpperCase() + '</td>' + '<td class="td_matricula">' + info[i].matricula + '</td>';
